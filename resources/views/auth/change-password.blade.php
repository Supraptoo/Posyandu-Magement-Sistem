...
<head>
    ...
    <title>{{ $title ?? 'Ganti Password' }} - SIPOSYANDU</title>
            ...
            <div class="col-md-8">
                <div class="change-password-card">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted">Anda wajib mengganti password untuk keamanan akun</p>
                    </div>
                    ...
                    <div class="text-center mt-3">
                        <small class="text-muted">
                            ...
                            Setelah mengganti password, Anda akan diarahkan ke dashboard
                        </small>
                    </div>
                </div>
            </div>
