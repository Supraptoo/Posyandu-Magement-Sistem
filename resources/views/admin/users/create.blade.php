...
<div class="main-content">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div>
                <h2><i class="fas fa-user-plus me-2"></i>Tambah User Warga Baru</h2>
    ...
    <div class="card-form">
        <div class="card-header-form">
            <h4 class="mb-0"><i class="fas fa-id-card me-2"></i>Form Pendaftaran Warga</h4>
            <p class="mb-0 opacity-75">Isi data warga dengan lengkap dan benar</p>
        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <small class="form-text text-muted">NIK akan digunakan sebagai username login</small>
                            @error('nik')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="alert alert-info">
                        ...
                        <ul class="mb-0 mt-2">
                            ...
                            <li>User wajib mengganti password saat login pertama kali</li>
                            <li>Status user akan di-set aktif secara otomatis</li>
                        </ul>
                    </div>
                </div>
                <!-- Status Akun -->
<div class="form-section">
    <h5 class="section-title"><i class="fas fa-cog me-2"></i>Status Akun</h5>
