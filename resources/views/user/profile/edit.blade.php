...
<div class="animate-fade-in pb-6 space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="name" value="{{ old('name', $user->name) }}" required class="block w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 text-slate-800 text-sm rounded-xl outline-none font-semibold focus:bg-white focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 transition-all shadow-inner">
                        </div>
                        @error('name') <p class="text-xs text-rose-500 font-medium mt-1.5 ml-1">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" value="{{ old('email', $user->email) }}" class="block w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 text-slate-800 text-sm rounded-xl outline-none font-semibold focus:bg-white focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 transition-all shadow-inner">
                        </div>
                        @error('email') <p class="text-xs text-rose-500 font-medium mt-1.5 ml-1">{{ $message }}</p> @enderror
                    </div>
                </div>
        ...
        <div class="bg-white border border-slate-100 rounded-[24px] shadow-[0_8px_30px_rgba(13,148,136,0.04)] overflow-hidden h-max">
            ...
            <form action="{{ route('password.change.post') }}" method="POST" class="p-6">
                @csrf
