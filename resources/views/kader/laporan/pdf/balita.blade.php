...
<body>
    ...
    <table class="meta-surat">
        <tr>
            ...
            <td width="2%">:</td>
            <td width="43%">440 / 056 / Ds.Btr / {{ date('Y') }}</td>
            <td width="40%" class="text-right">Bantar Kulon, {{ date('d F Y') }}</td>
        </tr>
        <tr>
            <td>Lampiran</td>
            <td>:</td>
    ...
    <div style="text-align: justify; margin-bottom: 15px;">
        ...
        <p style="text-indent: 30px;">
            Bersama surat ini, Pemerintah Desa Bantar Kulon menyampaikan Laporan Data Dasar Posyandu Semester {{ date('n') <= 6 ? 'I (Ganjil)' : 'II (Genap)' }} Tahun {{ date('Y') }}. Data ini disusun berdasarkan hasil monitoring dan evaluasi kader di lapangan untuk keperluan pemutakhiran data kesehatan masyarakat.
        </p>
    </div>
