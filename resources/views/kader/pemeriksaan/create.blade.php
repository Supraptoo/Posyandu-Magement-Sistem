                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <select class="form-select" name="pasien_type" id="pasien_type" onchange="changeFormType(this.value)" required>
                                ...
                                <option value="balita" {{ (old('pasien_type') ?? $pasien_type) == 'balita' ? 'selected' : '' }}>Balita</option>
                                <option value="remaja" {{ (old('pasien_type') ?? $pasien_type) == 'remaja' ? 'selected' : '' }}>Remaja</option>
                                <option value="lansia" {{ (old('pasien_type') ?? $pasien_type) == 'lansia' ? 'selected' : '' }}>Lansia</option>
                            </select>
                        </div>
                        <div class="col-md-8">
                ...
                <div class="mb-4 border-bottom pb-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="date" class="form-control" name="tanggal_kunjungan" value="{{ date('Y-m-d') }}" required>
                        </div>
                        <div class="col-md-4">
