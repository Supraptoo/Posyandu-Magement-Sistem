...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="login-footer">
                ...
                <p class="small text-muted">
                    &copy; <?php echo e(date('Y')); ?> SIPOSYANDU v2.0 - Sistem Informasi Posyandu
                </p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        <?php if(old('login')): ?>
            window.addEventListener('load', function() {
                const oldLogin = "<?php echo e(old('login')); ?>";
...
</html><?php /**PATH C:\xampp\htdocs\POSYANDU\posyandu-management-system\resources\views/auth/login.blade.php ENDPATH**/ ?>