...
<?php $__env->startSection('title', 'Tambah Data Lansia'); ?>
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?php echo e(route('kader.data.lansia.index')); ?>" class="btn btn-light text-primary fw-bold shadow-sm rounded-pill px-4">
        <i class="fas fa-arrow-left me-2"></i>Kembali
    </a>
</div>

<form action="<?php echo e(route('kader.data.lansia.store')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-lg-7">
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control form-control-lg bg-light border-0" name="nama_lengkap" value="<?php echo e(old('nama_lengkap')); ?>" required placeholder="Nama lengkap sesuai KTP">
            ...
            <div class="card border-0 shadow-md mb-4 rounded-4">
                ...
                <div class="card-body p-4">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control bg-light border-0" name="penyakit_bawaan" rows="3" placeholder="Contoh: Hipertensi, Diabetes, Asam Urat (Pisahkan dengan koma)"><?php echo e(old('penyakit_bawaan')); ?></textarea>
                        <div class="form-text small">Kosongkan jika tidak ada.</div>
                        <?php $__errorArgs = ['penyakit_bawaan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="text-danger small mt-1"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                         ...
                         <input type="text" class="form-control bg-light border-0" name="telepon_keluarga" value="<?php echo e(old('telepon_keluarga')); ?>" placeholder="Kontak darurat/keluarga">
                    </div>

                    <?php if($pendaftar && $pendaftar->count() > 0): ?>
                    <div class="mb-3">
                        ...
                        <select class="form-select bg-light border-0" name="created_by">
                            ...
                            <option value="<?php echo e($p['id']); ?>" <?php echo e(old('created_by') == $p['id'] ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.kader', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POSYANDU\posyandu-management-system\resources\views/kader/data/lansia/create.blade.php ENDPATH**/ ?>