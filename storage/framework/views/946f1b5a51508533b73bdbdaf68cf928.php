...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?php echo e(route('kader.data.balita.index')); ?>" class="btn btn-light text-primary fw-bold shadow-sm rounded-pill px-4">
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control form-control-lg bg-light border-0" name="nama_lengkap" value="<?php echo e(old('nama_lengkap')); ?>" required placeholder="Nama lengkap anak">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" class="form-control bg-light border-0" name="berat_lahir" value="<?php echo e(old('berat_lahir')); ?>" placeholder="0.00">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" class="form-control bg-light border-0" name="panjang_lahir" value="<?php echo e(old('panjang_lahir')); ?>" placeholder="0.00">
            ...
            <div class="card border-0 shadow-md mb-4 rounded-4">
                ...
                <div class="card-body p-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-light border-0" name="nama_ibu" value="<?php echo e(old('nama_ibu')); ?>" required placeholder="Nama Ibu Kandung">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-light border-0" name="nama_ayah" value="<?php echo e(old('nama_ayah')); ?>" placeholder="Nama Ayah">
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold small text-uppercase text-muted">Alamat Lengkap</label>
                        <textarea class="form-control bg-light border-0" name="alamat" rows="4" required placeholder="Jalan, RT/RW, Dusun..."><?php echo e(old('alamat')); ?></textarea>
