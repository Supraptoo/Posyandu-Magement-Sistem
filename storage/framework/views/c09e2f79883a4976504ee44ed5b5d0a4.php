...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?php echo e(route('kader.data.lansia.create')); ?>" class="btn btn-primary shadow-sm rounded-pill px-4">
    ...
    <div class="col-md-12">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-3">
                <form action="<?php echo e(route('kader.data.lansia.index')); ?>" method="GET">
                    <div class="input-group">
                        ...
                        <a href="<?php echo e(route('kader.data.lansia.index')); ?>" class="btn btn-light border ms-2" title="Reset">
    ...
    <div class="card-body p-0">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php $__currentLoopData = $lansias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lansia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="px-4 py-3">
                            <div class="d-flex align-items-center">
                                <div class="avatar-sm bg-<?php echo e($lansia->jenis_kelamin == 'L' ? 'primary' : 'danger'); ?>-subtle text-<?php echo e($lansia->jenis_kelamin == 'L' ? 'primary' : 'danger'); ?> rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 45px; height: 45px;">
                                    <i class="fas fa-user-clock fs-5"></i>
                                </div>
                                <div>
                                    <div class="fw-bold text-dark"><?php echo e($lansia->nama_lengkap); ?></div>
                                    <div class="small text-muted">
                                        <span class="badge bg-light text-dark border me-1"><?php echo e($lansia->kode_lansia); ?></span> 
                                        NIK: <?php echo e($lansia->nik); ?>
                        ...
                        <td class="py-3">
                            <div class="d-flex flex-column gap-1">
                                <span class="badge bg-light text-dark border fw-normal" style="width: fit-content;">
                                    ...
                                    <?php echo e($lansia->tanggal_lahir->age); ?> Tahun
                                </span>
                                <small class="text-muted"><?php echo e($lansia->tanggal_lahir->format('d M Y')); ?></small>
                            </div>
                        </td>
                        <td class="py-3">
                            <?php if($lansia->penyakit_bawaan): ?>
                                <?php $penyakits = explode(',', $lansia->penyakit_bawaan); ?>
                                <div class="d-flex flex-wrap gap-1" style="max-width: 250px;">
                                    <?php $__currentLoopData = $penyakits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $penyakit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="badge bg-danger-subtle text-danger border border-danger-subtle rounded-pill" style="font-size: 0.7rem;">
                                            <?php echo e(trim($penyakit)); ?>
                        ...
                        <td class="px-4 py-3 text-end">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg">
                                    <li><a class="dropdown-item" href="<?php echo e(route('kader.data.lansia.show', $lansia->id)); ?>"><i class="fas fa-eye me-2 text-info"></i>Detail</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('kader.data.lansia.edit', $lansia->id)); ?>"><i class="fas fa-edit me-2 text-warning"></i>Edit</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li>
                                        <button type="button" class="dropdown-item text-danger btn-delete" data-id="<?php echo e($lansia->id); ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    deleteButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            form.action = `<?php echo e(url('kader/data/lansia')); ?>/${id}`;
