...
<div class="stats-grid">
    <div class="stat-card danger">
        ...
        <div class="stat-content">
            ...
            <div class="stat-value"><?php echo e($stats['total_balita'] ?? 0); ?></div>
        </div>
    </div>
    ...
    <div class="stat-card secondary">
        ...
        <div class="stat-content">
            ...
            <div class="stat-value"><?php echo e($stats['total_remaja'] ?? 0); ?></div>
        </div>
    </div>
    ...
    <div class="stat-card dark">
        ...
        <div class="stat-content">
            ...
            <div class="stat-value"><?php echo e($stats['total_lansia'] ?? 0); ?></div>
        </div>
    </div>
    ...
    <div class="stat-card success">
        ...
        <div class="stat-content">
            ...
            <div class="stat-value"><?php echo e($stats['kunjungan_hari_ini'] ?? 0); ?></div>
        </div>
    </div>
    ...
    <div class="stat-card info">
        ...
        <div class="stat-content">
            ...
            <div class="stat-value"><?php echo e($stats['imunisasi_hari_ini'] ?? 0); ?></div>
        </div>
    </div>
    ...
    <div class="stat-card warning">
        ...
        <div class="stat-content">
            ...
            <div class="stat-value"><?php echo e($stats['kunjungan_saya_hari_ini'] ?? 0); ?></div>
        </div>
    </div>
    ...
    <div class="stat-card primary">
        ...
        <div class="stat-content">
            ...
            <div class="stat-value"><?php echo e($stats['jadwal_hari_ini'] ?? 0); ?></div>
        </div>
    </div>
    ...
    <div class="stat-card success">
        ...
        <div class="stat-content">
            ...
            <div class="stat-value"><?php echo e($pendaftaran_bulan_ini['total'] ?? 0); ?></div>
        </div>
    </div>
</div>
...
<div class="activity-section">
    ...
    <div class="activity-card">
        ...
        <div class="activity-list">
            <?php $__empty_1 = true; $__currentLoopData = $balita_baru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $balita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <a href="<?php echo e(route('kader.data.balita.show', $balita->id)); ?>" class="activity-item">
                <div class="activity-item-header">
                    <div>
                        <div class="activity-item-title"><?php echo e($balita->nama_lengkap); ?></div>
                        <div class="activity-item-meta">
                            <i class="fas fa-barcode"></i>
                            <?php echo e($balita->kode_balita); ?>

                        </div>
                    </div>
                    <span class="activity-badge badge-danger">
                        <?php echo e($balita->tanggal_lahir->diffInMonths(now())); ?> bulan
                    </span>
                </div>
            </a>
        ...
        <div class="action-buttons">
            <a href="<?php echo e(route('kader.data.balita.create')); ?>" class="btn-custom btn-primary-custom">
                <i class="fas fa-plus-circle"></i>
                Tambah Balita
            </a>
            <a href="<?php echo e(route('kader.data.balita.index')); ?>" class="btn-custom btn-outline-custom">
    ...
    <div class="activity-card">
        ...
        <div class="activity-list">
            <?php $__empty_1 = true; $__currentLoopData = $kunjungan_baru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kunjungan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="activity-item">
                <div class="activity-item-header">
                    <div>
                        <div class="activity-item-title"><?php echo e($kunjungan->pasien->nama_lengkap ?? 'Unknown'); ?></div>
                        <div class="activity-item-meta">
                            <i class="fas fa-clock"></i>
                            <?php echo e($kunjungan->jenis_kunjungan); ?> • <?php echo e($kunjungan->created_at->format('H:i')); ?>

                        </div>
                    </div>
                    <span class="activity-badge 
                        <?php if($kunjungan->pasien_type == 'App\Models\Balita'): ?> badge-danger
                        <?php elseif($kunjungan->pasien_type == 'App\Models\Remaja'): ?> badge-secondary
                        <?php else: ?> badge-dark <?php endif; ?>">
                        <?php if($kunjungan->pasien_type == 'App\Models\Balita'): ?> Balita
                        <?php elseif($kunjungan->pasien_type == 'App\Models\Remaja'): ?> Remaja
                        <?php else: ?> Lansia <?php endif; ?>
                    </span>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="action-buttons">
            <a href="<?php echo e(route('kader.pemeriksaan.create')); ?>" class="btn-custom btn-primary-custom">
                <i class="fas fa-plus-circle"></i>
                Tambah Kunjungan
            </a>
        </div>
    ...
    <div class="activity-card">
        ...
        <div class="activity-list">
            ...
            <div class="activity-item">
                <div class="activity-item-header">
                    <div>
                        <div class="activity-item-title"><?php echo e($jadwal->judul); ?></div>
                        <div class="activity-item-meta">
                            <i class="fas fa-calendar"></i>
                            <?php echo e($jadwal->tanggal); ?> • <?php echo e($jadwal->waktu_mulai); ?>

                        </div>
                    </div>
                    <span class="activity-badge" style="background: var(--secondary-color); color: var(--white);">
                        <?php echo e($jadwal->target_peserta); ?>
        ...
        <div class="action-buttons">
            <a href="<?php echo e(route('kader.jadwal.create')); ?>" class="btn-custom btn-primary-custom">
                <i class="fas fa-plus-circle"></i>
                Tambah Jadwal
            </a>
            <a href="<?php echo e(route('kader.jadwal.index')); ?>" class="btn-custom btn-outline-custom">
                <i class="fas fa-list"></i>
                Lihat Semua
            </a>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (kunjunganCtx) {
        const kunjunganLabels = <?php echo json_encode($kunjungan_7_hari->pluck('tanggal')); ?>;
        const kunjunganData = <?php echo json_encode($kunjungan_7_hari->pluck('total')); ?>;
    ...
    if (pendaftaranCtx) {
        new Chart(pendaftaranCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        <?php echo e($pendaftaran_bulan_ini['balita'] ?? 0); ?>,
                        <?php echo e($pendaftaran_bulan_ini['remaja'] ?? 0); ?>,
                        <?php echo e($pendaftaran_bulan_ini['lansia'] ?? 0); ?>
