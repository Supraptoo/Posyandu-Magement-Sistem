            ...
            <div class="col-md-6">
                <div class="real-time-clock">
                    ...
                    <div class="time-display">
                        <span id="currentTime"><?php echo e(now()->format('H:i')); ?></span>
                        <span class="seconds" id="currentSeconds">:<?php echo e(now()->format('s')); ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-4">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 mb-3 animate-fade-in-up delay-1">
            <div class="stat-card-modern stat-card-user">
                <div class="card-body">
                    <div class="stat-info">
                        <h3 class="stat-number" id="totalUsers"><?php echo e($stats['total_users'] ?? 0); ?></h3>
                        <p class="stat-label">Total Warga Aktif</p>
                        <?php if(isset($stats['users_change_percent'])): ?>
                        <div class="stat-change <?php echo e(($stats['users_change_percent'] ?? 0) >= 0 ? 'positive' : 'negative'); ?>">
                            <i class="fas fa-arrow-<?php echo e(($stats['users_change_percent'] ?? 0) >= 0 ? 'up' : 'down'); ?>"></i>
                            <span><?php echo e(number_format(abs($stats['users_change_percent'] ?? 0), 1)); ?>%</span>
                        </div>
                        <?php endif; ?>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 mb-3 animate-fade-in-up delay-2">
            <div class="stat-card-modern stat-card-kader">
                <div class="card-body">
                    <div class="stat-info">
                        <h3 class="stat-number" id="totalKaders"><?php echo e($stats['total_kaders'] ?? 0); ?></h3>
                        <p class="stat-label">Total Kader Aktif</p>
                        <?php if(isset($stats['kaders_change_percent'])): ?>
                        <div class="stat-change <?php echo e(($stats['kaders_change_percent'] ?? 0) >= 0 ? 'positive' : 'negative'); ?>">
                            <i class="fas fa-arrow-<?php echo e(($stats['kaders_change_percent'] ?? 0) >= 0 ? 'up' : 'down'); ?>"></i>
                            <span><?php echo e(number_format(abs($stats['kaders_change_percent'] ?? 0), 1)); ?>%</span>
                        </div>
                        <?php endif; ?>
                    </div>
                    <div class="stat-icon-container">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 mb-3 animate-fade-in-up delay-3">
            <div class="stat-card-modern stat-card-bidan">
                <div class="card-body">
                    <div class="stat-info">
                        <h3 class="stat-number" id="totalBidans"><?php echo e($stats['total_bidans'] ?? 0); ?></h3>
                        <p class="stat-label">Total Bidan Aktif</p>
                        <?php if(isset($stats['bidans_change_percent'])): ?>
                        <div class="stat-change <?php echo e(($stats['bidans_change_percent'] ?? 0) >= 0 ? 'positive' : 'negative'); ?>">
                            <i class="fas fa-arrow-<?php echo e(($stats['bidans_change_percent'] ?? 0) >= 0 ? 'up' : 'down'); ?>"></i>
                            <span><?php echo e(number_format(abs($stats['bidans_change_percent'] ?? 0), 1)); ?>%</span>
                        </div>
                        <?php endif; ?>
                    </div>
                    <div class="stat-icon-container">
                ...
                <div class="card-body">
                    <div class="stat-info">
                        <h3 class="stat-number" id="totalPatients">
                            <?php echo e((($stats['total_balita'] ?? 0) + ($stats['total_remaja'] ?? 0) + ($stats['total_lansia'] ?? 0))); ?>

                        </h3>
                        <p class="stat-label">Total Pasien</p>
                        <div class="stat-change info">
                            <i class="fas fa-chart-line"></i>
                            <span>Balita: <?php echo e($stats['total_balita'] ?? 0); ?></span>
                        </div>
                    </div>
                    <div class="stat-icon-container">
    ...
    <div class="row mb-4">
        ...
        <div class="col-xl-2 col-lg-4 col-md-6 mb-3 animate-fade-in-up delay-5">
            <div class="stat-card-modern stat-card-balita">
                <div class="card-body">
                    <div class="stat-info">
                        <h3 class="stat-number"><?php echo e($stats['total_balita'] ?? 0); ?></h3>
        ...
        <div class="col-xl-2 col-lg-4 col-md-6 mb-3 animate-fade-in-up delay-6">
            <div class="stat-card-modern stat-card-remaja">
                <div class="card-body">
                    <div class="stat-info">
                        <h3 class="stat-number"><?php echo e($stats['total_remaja'] ?? 0); ?></h3>
        ...
        <div class="col-xl-2 col-lg-4 col-md-6 mb-3 animate-fade-in-up delay-7">
            <div class="stat-card-modern stat-card-lansia">
                <div class="card-body">
                    <div class="stat-info">
                        <h3 class="stat-number"><?php echo e($stats['total_lansia'] ?? 0); ?></h3>
            ...
            <div class="stat-card-modern stat-card-active">
                <div class="card-body">
                    <div class="stat-info">
                        ...
                        ?>
                        <h3 class="stat-number"><?php echo e($stats['users_active'] ?? 0); ?></h3>
                        <p class="stat-label">User Aktif</p>
                        <?php if($totalAllUsers > 0): ?>
                        <div class="stat-change">
                            <i class="fas fa-percentage"></i>
                            <span><?php echo e(number_format($activePercentage, 1)); ?>%</span>
                        </div>
                        <?php endif; ?>
                    </div>
                    <div class="stat-icon-container">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3 animate-fade-in-up delay-9">
            <div class="stat-card-modern stat-card-inactive">
                <div class="card-body">
                    <div class="stat-info">
                        <h3 class="stat-number"><?php echo e($stats['users_inactive'] ?? 0); ?></h3>
                    ...
                    <div class="row g-3">
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6">
                            <div class="text-center">
                                <h3 class="text-primary"><?php echo e($stats['login_today'] ?? 0); ?></h3>
                                <p class="text-muted mb-0">Login</p>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6">
                            <div class="text-center">
                                <h3 class="text-success"><?php echo e($todayActivities['new_users_today'] ?? 0); ?></h3>
                                <p class="text-muted mb-0">User Baru</p>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6">
                            <div class="text-center">
                                <h3 class="text-warning"><?php echo e($todayActivities['kunjungan_today'] ?? 0); ?></h3>
                                <p class="text-muted mb-0">Kunjungan</p>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6">
                            <div class="text-center">
                                <h3 class="text-info"><?php echo e($todayActivities['pemeriksaan_today'] ?? 0); ?></h3>
                                <p class="text-muted mb-0">Pemeriksaan</p>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6">
                            <div class="text-center">
                                <h3 class="text-danger"><?php echo e($todayActivities['imunisasi_today'] ?? 0); ?></h3>
                                <p class="text-muted mb-0">Imunisasi</p>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6">
                            <div class="text-center">
                                <h3 class="text-secondary"><?php echo e($stats['new_users_month'] ?? 0); ?></h3>
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                            <a href="<?php echo e(route('admin.users.create')); ?>" class="btn btn-action-modern btn-user">
                                <i class="fas fa-user-plus action-icon"></i>
                                <span class="action-text">Tambah Warga</span>
                            </a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                            <a href="<?php echo e(route('admin.kaders.create')); ?>" class="btn btn-action-modern btn-kader">
                                <i class="fas fa-user-nurse action-icon"></i>
                                <span class="action-text">Tambah Kader</span>
                            </a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                            <a href="<?php echo e(route('admin.bidans.create')); ?>" class="btn btn-action-modern btn-bidan">
                                <i class="fas fa-user-md action-icon"></i>
                                <span class="action-text">Tambah Bidan</span>
                            </a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                            <a href="<?php echo e(route('admin.pasien.balita.create')); ?>" class="btn btn-action-modern btn-pasien">
                                <i class="fas fa-baby action-icon"></i>
                                <span class="action-text">Tambah Pasien</span>
                            </a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                            <a href="<?php echo e(route('admin.settings.index')); ?>" class="btn btn-action-modern btn-setting">
        ...
        <div class="col-xl-4 col-lg-5 mb-4">
            <div class="status-card animate-fade-in-up delay-6">
                ...
                <div class="status-item">
                    ...
                    <span class="status-value"><?php echo e($totalAllUsers); ?></span>
                </div>
                
                <div class="status-item">
                    <span class="status-label">User Aktif</span>
                    <span class="status-value"><?php echo e($totalActive); ?> / <?php echo e($totalAllUsers); ?></span>
                </div>
                
                <div class="status-item">
                    <span class="status-label">User Baru Bulan Ini</span>
                    <span class="status-value"><?php echo e($stats['new_users_month'] ?? 0); ?></span>
                </div>
                ...
                <div class="status-item">
                    ...
                    <span class="status-value"><?php echo e($totalPatients); ?></span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-6 mb-4">
            <div class="activity-timeline animate-fade-in-up delay-7">
                ...
                <div class="card-body p-0">
                    <?php if(isset($recentActivities['new_users']) && $recentActivities['new_users']->count() > 0): ?>
                        <ul class="timeline">
                            <?php $__currentLoopData = $recentActivities['new_users']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                ?>
                                <li class="timeline-item <?php echo e($timelineClass); ?>">
                                    <div class="timeline-content">
                                        <div class="d-flex align-items-center">
                                            <div class="me-3">
                                                <i class="<?php echo e($roleIcon); ?> fa-lg"></i>
                                            </div>
                                            <div>
                                                <p class="timeline-title mb-1">
                                                    <strong><?php echo e($user->profile->full_name ?? 'User Baru'); ?></strong>
                                                    <small class="ms-2 badge bg-<?php echo e($badgeColor); ?>">
                                                        <?php echo e($roleText); ?>
                                                ...
                                                <p class="timeline-time mb-0">
                                                    ...
                                                    <span class="ms-2"><?php echo e($user->created_at->format('H:i')); ?></span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="row mb-4">
        <div class="col-xl-6 mb-4">
            <div class="activity-timeline animate-fade-in-up delay-9">
                ...
                <div class="card-body p-0">
                    <?php if(isset($recentActivities['recent_logins']) && $recentActivities['recent_logins']->count() > 0): ?>
                        <ul class="timeline">
                            <?php $__currentLoopData = $recentActivities['recent_logins']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $login): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $timelineClass = 'timeline-user';
                                    $roleText = 'Warga';
                                    $roleIcon = 'fas fa-user-circle';
                                ...
                                <li class="timeline-item <?php echo e($timelineClass); ?>">
                                    <div class="timeline-content">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="timeline-title mb-1">
                                                    <strong><?php echo e($login->user->profile->full_name ?? 'User'); ?></strong>
                                                    <small class="ms-2 badge bg-<?php echo e($badgeColor); ?>">
                                                        <?php echo e($roleText); ?>
                                                ...
                                                <p class="timeline-time mb-0">
                                                    <i class="far fa-clock me-1"></i>
                                                    <?php echo e($login->login_at->diffForHumans()); ?>

                                                    <span class="ms-2"><?php echo e($login->login_at->format('H:i:s')); ?></span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="col-xl-6 mb-4">
            <div class="status-card animate-fade-in-up delay-10">
                ...
                <?php if(isset($topActiveUsers) && $topActiveUsers->count() > 0): ?>
                    <div class="list-group list-group-flush">
                        <?php $__currentLoopData = $topActiveUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-3">
                                <span class="badge bg-<?php echo e($badgeColor); ?> rounded-circle p-2">
                                    <?php echo e($index + 1); ?>
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between">
                                    <span class="fw-medium"><?php echo e($user->user->profile->full_name ?? 'User'); ?></span>
                                    <span class="badge bg-<?php echo e($roleColor); ?>">
                                        <?php echo e($user->user->role); ?>

                                    </span>
                                </div>
                                <small class="text-muted"><?php echo e($user->login_count); ?> login</small>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const userData = <?php echo json_encode($userData ?? [], 15, 512) ?>;
        const kunjunganData = <?php echo json_encode($kunjunganData ?? [], 15, 512) ?>;
        const pemeriksaanData = <?php echo json_encode($pemeriksaanData ?? [], 15, 512) ?>;
    ...
    function refreshStats() {
        fetch('<?php echo e(route("admin.dashboard")); ?>/stats?refresh=true')
