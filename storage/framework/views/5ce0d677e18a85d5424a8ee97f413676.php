    ...
    <div class="card-body p-0">
        <div class="bg-primary p-4 text-white position-relative overflow-hidden" style="min-height: 150px;">
            ...
            <div class="d-flex align-items-center position-relative z-index-1">
                ...
                <div>
                    <h2 class="fw-bold mb-1"><?php echo e($remaja->nama_lengkap); ?></h2>
                    <div class="d-flex gap-2 mb-2">
                        <span class="badge bg-white text-primary"><i class="fas fa-id-card me-1"></i> <?php echo e($remaja->nik); ?></span>
                        <span class="badge bg-<?php echo e($remaja->jenis_kelamin == 'L' ? 'info' : 'danger'); ?> text-white">
                            <i class="fas fa-venus-mars me-1"></i> <?php echo e($remaja->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan'); ?>

                        </span>
                        <span class="badge bg-white text-dark"><i class="fas fa-hashtag me-1"></i> <?php echo e($remaja->kode_remaja); ?></span>
                    </div>
                </div>
                <div class="ms-auto d-none d-md-block text-end">
                    <a href="<?php echo e(route('kader.data.remaja.edit', $remaja->id)); ?>" class="btn btn-light text-primary fw-bold rounded-pill px-4 shadow-sm">
            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        ...
                        <div class="fw-bold text-dark"><?php echo e($remaja->sekolah); ?></div>
                    </div>
                </div>
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="fw-bold text-dark"><?php echo e($remaja->kelas); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        ...
                        <div class="fw-bold text-dark"><?php echo e($remaja->nama_ortu ?? '-'); ?></div>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        ...
                        <div class="fw-bold text-dark"><?php echo e($remaja->telepon_ortu ?? '-'); ?></div>
                    </div>
                </div>
                ...
                <div class="d-flex mb-3">
                    ...
                    <div>
                        ...
                        <div class="text-dark"><?php echo e($remaja->alamat); ?></div>
                    </div>
                </div>
                ...
                <div class="d-flex">
                    ...
                    <div>
                        ...
                        <div class="text-dark"><?php echo e($remaja->tempat_lahir); ?>, <?php echo e($remaja->tanggal_lahir->format('d M Y')); ?></div>
                        <small class="text-primary fw-bold">
                            <?php echo e($remaja->tanggal_lahir->diffInYears(now())); ?> Tahun
                        </small>
                    </div>
                </div>
            </div>
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm rounded-4 h-100">
            <div class="card-header bg-white border-bottom-0 pt-4 px-4 d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('kader.pemeriksaan.create')); ?>?pasien_id=<?php echo e($remaja->id); ?>&pasien_type=remaja" class="btn btn-primary btn-sm rounded-pill px-3 shadow-sm">
                    <i class="fas fa-plus me-1"></i> Kunjungan Baru
                </a>
            </div>
            <div class="card-body p-4">
                <?php if($remaja->kunjungans && $remaja->kunjungans->count() > 0): ?>
                    <div class="timeline">
                        <?php $__currentLoopData = $remaja->kunjungans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kunjungan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
